class Spree::Admin::OrganizationsController < Spree::Admin::ResourceController
  ...
  private
    ...
    def organization_params
      params.require(:organization).permit(:company_name,:company_code,:facebook_url,:google_analyitcs,:twitter_url,:google_url,:central_time,:opening_hour, :opening_day, :closing_hour, :closing_day, :youtube, :linked_in, :pinterest, org_addresses_attributes: [:id, :company_name, :country,:company_address,:city, :state, :postal_code,:phone_no, :_destroy])
