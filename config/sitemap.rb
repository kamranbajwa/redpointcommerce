SitemapGenerator::Sitemap.default_host = "http://#{Spree::Store.first.url}"
...
SitemapGenerator::Sitemap.adapter = SitemapGenerator::S3Adapter.new({
    aws_access_key_id:  'AKIAJJGUHCUAKNL2LYAQ',
    aws_secret_access_key: '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',
    fog_provider: "aws",
    fog_directory: "redpoint-commerce"
